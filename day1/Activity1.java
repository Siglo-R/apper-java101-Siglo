...
class FlamesHope {
    ...
    public static void main(String[] args) {
        ...
        // ITEM#1: Check if name is not empty. If empty, display "Your name is
        // required." then the program should terminate
        ...
        // ITEM#2: Check if crushName is not empty. If empty, display "Your crushName is
        // required." then the program should terminate
        System.out.print("What's your crush name: ");
        ...
        if (result < 50) {
            ...
            System.out.println(name + crushName + " is <3");
        }

        // ITEM#5 if result is less than 50, display "SAD :( ", else display name and
        // crush name with <3 E.g "Orvyl and JY is <3"
    }
